...
Success
Details 
Runtime: 15 ms, faster than 45.55% of C++ online submissions for Valid Anagram.
Memory Usage: 7.3 MB, less than 46.06% of C++ online submissions for Valid Anagram.
*/
...
*/
//SUBMTTED SOLUTION (USING ARRAYS)
class Solution {
public:
    bool isAnagram(string s, string t) {
        if (s.length() != t.length()) return false;
...
//END OF SUBMTTED SOLUTION (USING ARRAYS)
/*
Sorting
